...
import { ColorScheme, SystemConfig, EnvironmentKey, EnvironmentEffects, EnvironmentThemes } from '@/shared/types/types';
import { DEFAULT_DARK, DEFAULT_ENVIRONMENT_THEMES } from '@/infrastructure/config/themeDefaults';
