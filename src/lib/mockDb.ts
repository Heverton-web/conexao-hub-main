...
const localAccessLogs: AccessLog[] = [
    { id: 'log-1', materialId: 'mat-1', materialTitle: 'Tutorial de Implantes', userId: 'mock-client', userName: 'Cliente Exemplo', userRole: 'client', language: 'pt-br', timestamp: new Date().toISOString() },
    { id: 'log-2', materialId: 'mat-2', materialTitle: 'Guia de Marketing', userId: 'mock-consult', userName: 'Consultor Demo', userRole: 'consultant', language: 'pt-br', timestamp: new Date().toISOString() },
];
